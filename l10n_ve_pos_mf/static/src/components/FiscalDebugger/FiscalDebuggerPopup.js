 ...
 *
 * Migrado desde `AbstractAwaitablePopup` (eliminado en Odoo 19) al patrón
 * `Dialog` de `@web/core/dialog/dialog` (mismo patrón usado en
 * l10n_ve_iot_mf/static/src/backend/mf_fiscalizador_dialog.js).
 */
export class FiscalDebuggerPopup extends Component {
    ...
    setup() {
        this.title = _t("Fiscalizador - Debugger de Máquina Fiscal");
